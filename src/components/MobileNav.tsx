...
type MobileNavProps = {
  activePage: "home" | "thesis" | "work" | "about" | "projects" | "thinking" | "contact";
};

const NAV_LINKS = [
  { href: "/", label: "Home", page: "home" },
  { href: "/thesis", label: "Thesis", page: "thesis" },
  { href: "/work", label: "Work", page: "work" },
  { href: "/about", label: "About", page: "about" },
  { href: "/projects", label: "Projects", page: "projects" },
  { href: "/thinking", label: "Thinking", page: "thinking" },
    ...
    <>
      ...
      <div className={`mobile-overlay${isOpen ? " open" : ""}`}>
        ...
        <div className="mobile-overlay-social">
          <a
            href="https://linkedin.com/in/richezamorjr/"
            target="_blank"
