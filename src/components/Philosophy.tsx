      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-5 mb-8">
              <div className="flex items-start gap-3">
                ...
                <p className="text-muted leading-relaxed">
                  AI shouldn&apos;t just respond, it should anticipate based on the
                  architected memory of previous interactions.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 mt-0.5 rounded-full bg-accent/20 flex items-center justify-center shrink-0">
                ...
                <p className="text-muted leading-relaxed">
                  The &ldquo;Context Layer&rdquo; is the missing link between generic
                  intelligence and personalized utility.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 mt-0.5 rounded-full bg-accent/20 flex items-center justify-center shrink-0">
                ...
                <p className="text-muted leading-relaxed">
                  Models get smarter monthly. Context Layers are the new moat.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 bg-card-bg border border-card-border rounded-xl overflow-hidden">
            ...
            <div className="bg-card-bg border border-card-border rounded-xl p-6 flex flex-col justify-center items-center text-center">
